  ...
  return (
    <>
      <div className="p-4 sm:p-6 bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all duration-200 w-full dark:bg-gray-800 dark:border-gray-700">
        {/* Header Section */}
       <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 w-full break-words">
          <div className="flex items-start gap-3 w-full">
            <div className="h-3 w-3 bg-blue-500 rounded-full mt-1.5 flex-shrink-0 dark:bg-blue-400" />
            <div className="flex-1 min-w-0">
              <h2 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white break-words whitespace-normal">
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            >
              ...
              <strong>{interview?.jobPosition}</strong>? This action cannot be
